...
<div class="row">
    <div class="col">
        ...
        @if($resultados == 0)
        <p>No se han encontrado resultados para la búsqueda: <span class="font-weight-bold">{{$item}}</span></p>
        @else
        <p>Se han encontrado {{$resultados}} resultados para la búsqueda: <span class="font-weight-bold">{{$item}}</span></p>
        @endif
    </div>
</div>
